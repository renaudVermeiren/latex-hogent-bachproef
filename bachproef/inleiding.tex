...
Het doel van deze bachelorproef is om vanuit deze probleemstelling een toegepast onderzoek uit te voeren dat zowel inzicht oplevert in de prestaties van verschillende LLM’s als concrete handvatten biedt voor studenten. Enerzijds wordt geprobeerd om via gestructureerde experimenten de kwaliteit van LLM gegenereerde Python code te evalueren op het vlak van syntaxis, style, beveiliging, uitvoerbaarheid, performantie, onderhoudbaarheid en functionele correctheid in realistische data engineering taken.
