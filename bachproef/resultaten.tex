...
\begin{figure}[htbp]
    ...
    \caption{Algemene rangschikking van de modellen op basis van de gemiddelde kwaliteitsscore over alle evaluatoren (exclusief functionele correctheid). Llama 3 voert de rangschikking aan met 96,1\%, gevolgd door DeepSeek Coder V2 (95,7\%) en Qwen 2.5 Coder (95,6\%).}
