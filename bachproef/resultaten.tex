...
\textbf{Figuur \ref{fig:lines_of_code}} geeft een boxplot-weergave van de code-omvang per model.
...
\begin{figure}[htbp]
    ...
    \caption{Uitvoeringstijden (seconden) per model in boxplotweergave. De figuur geeft inzicht in de runtime-efficiëntie van de gegenereerde code.}
...
\begin{figure}[htbp]
    ...
    \caption{Boxplot van de code-omvang (aantal regels) per model. De figuur toont de mediaan, interkwartielafstand en uitschieters.}
...
\begin{figure}[htbp]
    ...
    \caption{Consistentie van de drie gegenereerde samples per model en per evaluator, weergegeven als gemiddelde standaarddeviatie. Een lagere waarde wijst op een betrouwbaardere codegeneratie.}
